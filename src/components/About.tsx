        ...
        <div className="flex flex-col md:flex-row gap-12 lg:gap-20">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-white/60 leading-relaxed max-w-2xl">
              ...
              <p>
                I thrive on solving complex problems. My background in <span className="text-white font-medium">Competitive Programming</span> 
                has sharpened my analytical thinking, allowing me to approach challenges with efficiency and scale in mind.
              </p>
              <p>
                Currently, I specialize in the <span className="text-accent font-medium">MERN stack</span> (MongoDB, Express, React, Node) 
                and <span className="text-accent font-medium">React Native</span>, bridging the gap between desktop and mobile environments. 
                Whether it's building real-time multiplayer games or robust enterprise systems with PostgreSQL, 
                I'm always eager to explore new technologies and push my limits.
              </p>
            </div>
            ...
            <div className="relative z-10 w-full aspect-square max-w-[500px] ml-auto group">
              ...
              <div className="w-full h-full glass rounded-[40px] overflow-hidden p-3 relative">
                <div className="w-full h-full rounded-[32px] overflow-hidden bg-surface relative">
                   <img 
                      src="src/assets/shariful_islam.jpg" 
                      alt="Shariful Islam" 
